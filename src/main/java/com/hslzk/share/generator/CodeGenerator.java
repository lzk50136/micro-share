package com.hslzk.share.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        sc
                ...
                //.setFieldPrefix()
                // 自定义继承的Entity类全称，带包名
                //.setSuperEntityClass("com.hslzk.share.base.BaseEntity")
                // 自定义基础的Entity类，公共字段
                //.setSuperEntityColumns("createTime", "modifiedTime")
                // 自定义继承的Mapper类全称，带包名
                //.setSuperMapperClass("com.hslzk.share.mapper.BaseMapper")
                // 自定义继承的Service类全称，带包名
                // .setSuperServiceClass("com.hslzk.share.TestService")
                // 自定义继承的ServiceImpl类全称，带包名
                // .setSuperServiceImplClass("com.hslzk.share.TestServiceImpl")
                // 自定义继承的Controller类全称，带包名
                //.setSuperControllerClass("com.hslzk.share.controller.AbstractController")
